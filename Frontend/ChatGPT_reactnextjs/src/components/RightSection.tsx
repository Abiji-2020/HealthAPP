    ...
    const trainingPrompt = [
        {
            "role": "user",
            "parts": [{
                "text": "This is Introductory dialogue for any prompt :  'Hello, my dear friend, I am the HEALTH Bot. Ask me anything regarding procurement, purchase, and logistics. I will be happy to help you. '"
            }]
        },
        {
            "role": "model",
            ...
            <div className={styles.rightin}>
                    ...
                    allMessages.length > 0 ?
                        <div className={styles.messages}>
                            {allMessages.map((msg, index) => (
                                <div key={index} className={styles.message}>
                                    <Image src={msg.role === 'user' ? calmlogo : calmlogo} width={50} height={50} alt="" />
                                    <div className={styles.details}>
                                        <h2>{msg.role === 'user' ? 'You' : 'HEALTH Bot'}</h2>
                        ...
                        <div className={styles.nochat}>
                            <div className={styles.s1}>
                                {/* <Image src={calmlogo} alt="HEALTH BOT" height={70} width={70} /> */}
                ...
                <div className={styles.bottomsection}>
                    <div className={styles.messagebar}>
                        <input type='text' placeholder='Message Health Bot...'
